...
export default function EditSuccessModal({ campaign, isOpen, onClose }: EditSuccessModalProps) {
        ...
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-bold text-white shadow-[0_0_10px_rgba(255,255,255,0.5)]">Updated!</h2>
            </div>
            <button 
              onClick={onClose}
